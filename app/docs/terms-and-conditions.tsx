      ...
      >
        ...
        <View style={styles.section}>
          ...
          <View style={styles.bulletList}>
            ...
            <Text style={styles.bulletPoint}>• You possess a valid driver&apos;s licence or appropriate vehicle registration (if required).</Text>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.bulletList}>
            ...
            <Text style={styles.bulletPoint}>• You agree to notify us immediately if you suspect unauthorised use of your account.</Text>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.bulletList}>
            <Text style={styles.bulletPoint}>• Maintain a valid driver&apos;s licence and vehicle registration (if applicable).</Text>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.bulletList}>
            ...
            <Text style={styles.bulletPoint}>• You must collect orders from the assigned Surespot kitchen or branch in a timely manner.</Text>
            ...
            <Text style={styles.bulletPoint}>• You must maintain professional conduct with customers and Surespot staff.</Text>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.bulletList}>
            ...
            <Text style={styles.bulletPoint}>• Payouts will be processed to your registered bank account on a scheduled basis.</Text>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.bulletList}>
            ...
            <Text style={styles.bulletPoint}>• Harass, abuse, or harm customers or Surespot staff.</Text>
            ...
            <Text style={styles.bulletPoint}>• Attempt to gain unauthorised access to our systems or other riders&apos; accounts.</Text>
            <Text style={styles.bulletPoint}>• Interfere with or disrupt the Services.</Text>
          </View>
        </View>

        <View style={styles.section}>
          <Text style={styles.sectionTitle}>10. Privacy and Location Tracking</Text>
          <Text style={styles.sectionText}>
            Our Privacy Policy explains how we collect, use, and share your personal information, including your real-time GPS location, device data, earnings data, and push notification token. By marking yourself as online in the app, you consent to continuous background location tracking for the purpose of matching you with nearby delivery requests and sharing your position with customers during active deliveries. Please review the full Privacy Policy in the app.
          </Text>
        </View>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.bulletList}>
            ...
            <Text style={styles.bulletPoint}>• Any other reason we deem necessary to protect the platform or customers.</Text>
          </View>
          <Text style={styles.sectionText}>
          ...
          <Text style={styles.sectionText}>
            You may also close your own account at any time by going to Profile → Support &amp; Legal → Deactivate Account in the app. Closing your account does not cancel any outstanding payout obligations owed to you.
          </Text>
        </View>
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.sectionText}>
            If you have any questions about these Terms or your rights and responsibilities as a delivery rider, please contact us through the app or at admin@surespot.ng.
          </Text>
        </View>
      </ScrollView>
    </SafeAreaView>
