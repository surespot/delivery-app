...
import { ACCOUNT_VERIFICATION_TYPE_MAP } from '@/src/api/support/utils';
...
export default function SupportAccountVerificationScreen() {
  ...
  const handleSubmit = async () => {
    ...
    const apiType = ACCOUNT_VERIFICATION_TYPE_MAP[selectedType];
    if (!apiType) {
    ...
    formData.append('category', 'account_verification');
